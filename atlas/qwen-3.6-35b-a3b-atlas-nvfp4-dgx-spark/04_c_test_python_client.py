...
MODEL = os.environ.get("ATLAS_MODEL", "RedHatAI/Qwen3.6-35B-A3B-NVFP4")
...
if not TEST_PROMPT_FILE.exists():
    ...
    TEST_PROMPT_FILE.write_text(
        "Hello! Can you briefly explain the advantages of Atlas inference engine and its pure Rust architecture?",
        encoding="utf-8",
    )
