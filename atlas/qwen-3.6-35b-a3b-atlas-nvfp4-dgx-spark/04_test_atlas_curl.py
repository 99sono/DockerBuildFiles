#!/usr/bin/env python3
"""
04_test_atlas_curl.py - Clean test script for Atlas Qwen 3.6 MoE using OpenAI client
"""
...
if not TEST_PROMPT_FILE.exists():
    ...
    TEST_PROMPT_FILE.write_text("Hello! Can you briefly explain the advantages of Atlas inference engine and its pure Rust architecture?", encoding="utf-8")

prompt = TEST_PROMPT_FILE.read_text(encoding="utf-8")

print("🚀 Sending request to Atlas Qwen 3.6 MoE via Python client")
