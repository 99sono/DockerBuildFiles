...
#   bash <path-to>/ninfer/log-parser/03_parse_docker_log_file_to_markdown_report.sh <log_file> [output.md]
#
...
conda run --no-capture-output -n testNInferLogParse python "$SCRIPT_DIR/parse_docker_log.py" "$input" -o "$output"
