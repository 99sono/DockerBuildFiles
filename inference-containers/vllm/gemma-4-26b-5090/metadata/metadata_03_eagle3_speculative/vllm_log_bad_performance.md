...
2026-04-19 17:44:23.422 | (APIServer pid=1) INFO:     172.18.0.1:56704 - "POST /v1/chat/completions HTTP/1.1" 200 OK
2026-04-19 17:44:33.981 | (APIServer pid=1) INFO 04-19 15:44:33 [loggers.py:271] Engine 000: Avg prompt throughput: 7098.9 tokens/s, Avg generation throughput: 9.7 tokens/s, Running: 1 reqs, Waiting: 0 reqs, GPU KV cache usage: 13.5%, Prefix cache hit rate: 0.0%
2026-04-19 17:44:33.981 | (APIServer pid=1) INFO 04-19 15:44:33 [metrics.py:101] SpecDecoding metrics: Mean acceptance length: 1.01, Accepted throughput: 0.00 tokens/s, Drafted throughput: 0.71 tokens/s, Accepted: 1 tokens, Drafted: 285 tokens, Per-position acceptance rate: 0.011, 0.000, 0.000, Avg Draft acceptance rate: 0.4%
2026-04-19 17:44:42.601 | (APIServer pid=1) INFO:     172.18.0.1:56704 - "POST /v1/chat/completions HTTP/1.1" 200 OK
2026-04-19 17:44:44.119 | (APIServer pid=1) INFO 04-19 15:44:44 [loggers.py:271] Engine 000: Avg prompt throughput: 0.0 tokens/s, Avg generation throughput: 19.8 tokens/s, Running: 0 reqs, Waiting: 1 reqs, GPU KV cache usage: 0.0%, Prefix cache hit rate: 0.0%
2026-04-19 17:44:44.119 | (APIServer pid=1) INFO 04-19 15:44:44 [metrics.py:101] SpecDecoding metrics: Mean acceptance length: 1.00, Accepted throughput: 0.00 tokens/s, Drafted throughput: 59.40 tokens/s, Accepted: 0 tokens, Drafted: 594 tokens, Per-position acceptance rate: 0.000, 0.000, 0.000, Avg Draft acceptance rate: 0.0%
2026-04-19 17:44:54.120 | (APIServer pid=1) INFO 04-19 15:44:54 [loggers.py:271] Engine 000: Avg prompt throughput: 0.0 tokens/s, Avg generation throughput: 0.0 tokens/s, Running: 0 reqs, Waiting: 1 reqs, GPU KV cache usage: 0.0%, Prefix cache hit rate: 0.0%
2026-04-19 17:47:28.626 | (APIServer pid=1) INFO:     Shutting down
2026-04-19 17:47:28.726 | (APIServer pid=1) INFO:     Waiting for application shutdown.
2026-04-19 17:47:28.726 | (APIServer pid=1) INFO:     Application shutdown complete.
2026-04-19 17:47:28.726 | (APIServer pid=1) INFO:     Finished server process [1]